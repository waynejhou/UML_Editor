...
public class GeneralizationLineShape extends LineShape {
    public final static ILineShapeCreator Creator = new ILineShapeCreator() {
        @Override
        public LineShape cr8Shape() {
            return new GeneralizationLineShape();
        }
    };
    public GeneralizationLineShape() {
    ...
    protected void HowToDrawFG(Graphics2D g, int x, int y, int w, int h) {
        ...
        g.fillPolygon(new int[] { pt1.x + ox, lx1 + ox, mm1x + ox, rx1 + ox },
